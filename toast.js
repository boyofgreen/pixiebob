(function(){
    ...
    if (typeof Windows !== 'undefined' &&
        ...
        input.setAttribute('title', 'Enter Email:   ');
...
function notify () {
    ...
    message = "Would you like to provide The Great Courses with your email address?"
    imgUrl = 'http://pixiebobee12.azurewebsites.net/images/logo.scale-100.png';
    imgAlt = 'this is image alt'

    createToast(title, message, imgUrl, imgAlt, tag, lang);
}

setTimeout(notify, 25000);
